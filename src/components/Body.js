...
//         <h1 className="text-6xl font-medium text-gray-200 italic ">Ritik Pandey</h1> 
//         <div className="flex items-center"> 
//           <div className="flex-1"> 
//             <p className="text-lg text-gray-100 mb-4 transition-opacity duration-500 ease-in-out italic
...
//             </p> 
//           </div> 
//           <img src={profileImage} alt="Ritik Pandey" className="w-1/4 rounded-full ml-8" /> 
//         </div> 
//       </div> 
//       <BelowBody />
//     </div>
...
const Body = () => {
  ...
  return (
    <div className="bg-gray-800 h-screen flex flex-col items-center justify-center overflow-hidden">
      <Header />
      <motion.div 
      ...
      >
        <motion.h1 
          className="text-6xl font-medium text-gray-200 italic"
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            <p className={`text-lg text-gray-100 mb-4 italic transition-opacity duration-500 ease-in-out ${isAnimated ? 'opacity-100' : 'opacity-0'}`}>
              With a remarkable blend of powerful vocals and masterful guitar skills, Ritik is a true performer. 
              Their voice, rich in emotion and versatility, captivates audiences across all genres. 
              Whether it’s an intimate acoustic session or a high-energy live performance, 
              Ritik effortlessly connects with their listeners, bringing raw passion and authenticity to every note. 
